        ...
        <div class="container-fluid pt-4 pb-4">
            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Records to Display..!" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" DataKeyNames="ContactId" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting">
                        <columns>
